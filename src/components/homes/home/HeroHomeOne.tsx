...
export default function HeroHomeOne() {
  return (
    <>
      <section className="banner-section style-v1 overflow-hidden" style={{ backgroundImage: 'url(assets/img/banner/hero1-bg.jpg)' }}>
          ...
          <div className="row g-4 align-items-center position-relative">
            <div className="col-lg-7 col-md-7 col-sm-9">
              <div className="hero-contentv01">
                ...
                <Link to="/about" className="cmn-btn round100 wow fadeInUp" data-wow-delay="0.9s">
                  View More
